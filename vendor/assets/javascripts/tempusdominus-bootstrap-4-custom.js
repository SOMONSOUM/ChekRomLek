    ...
    var TempusDominusBootstrap4 = function (_DateTimePicker) {
        ...
        TempusDominusBootstrap4.prototype._getToolbar = function _getToolbar() {
            ...
            if (this._options.buttons.showClear) {
                row.push($('<a>CANCEL</a>').attr({
                    href: '#',
                    class: 'btn btn-secondary btn-action btn-cancel',
                    tabindex: '-1',
                    'title': 'CANCEL'
                }));
            }
            if (this._options.buttons.showClose) {
                row.push($('<a>OK</a>').attr({
                    href: '#',
            ...
            return $('<div>').attr({role: 'group'}).addClass('btn-group').append(row);
        };
        ...
        TempusDominusBootstrap4.prototype._getTemplate = function _getTemplate() {
            var template = $('<div>').addClass('bootstrap-datetimepicker-widget dropdown-menu'),
                ...
                toolbar = $('<div>').addClass('picker-switch row' + (this._options.collapse ? ' accordion-toggle' : '')).append(this._getToolbar());
            ...
            if (this._options.sideBySide && this._hasDate() && this._hasTime()) {
                ...
                template.append($('<div>').addClass('row').append(dateView.addClass('col-md-12')).append(timeView.addClass('col-md-12')));
